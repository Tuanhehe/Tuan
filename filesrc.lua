...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>tuanmom chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "tuanmom", HidePremium = false, IntroText = "tuanmom⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("tuanmom SCRIPT")
W:AddLabel("Discordtuanmom")
local Section = W:AddSection({
    Name = "Status"
})
